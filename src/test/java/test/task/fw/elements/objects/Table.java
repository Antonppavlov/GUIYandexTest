...
/**
 * Represents web page table elements. Provides convenient ways of retrieving data stored in it.
 *
 * @author Alexander Tolmachev starlight@yandex-team.ru
 *         Date: 11.03.13
 */
// TODO: 08.08.2016 какая-от дичь от яндекса, посмотреть и перепилить 
public class Table {
    private final SelenideElement selenideElement;

    /**
     * Specifies {@link SelenideElement} representing table tag.
     *
     * @param selenideElement {@code WebElement} to wrap.
     */
    public Table(SelenideElement selenideElement) {
     ...
     */
    public List<SelenideElement> getHeadings() {
        return selenideElement.$$(By.xpath(".//th"));
    }
    ...
    public List<WebElement> getColumnByIndex(int index) {
        return selenideElement.findElements(
    ...
    /**
     * Returns table cell elements ({@code <td>}), at i-th row and j-th column.
     *
     * @param i Row number
     * @param j Column number
     * @return Cell elements at i-th row and j-th column.
     */
